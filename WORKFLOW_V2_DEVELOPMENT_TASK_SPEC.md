...
- T04 完成后剩余基准串行计划为 91 人日，功能和发布任务计划完成日仍为 2026-12-15。
...
- 已更新 README、真实 SDK 指南、Phase 1/2 报告和 1.0→2.0 能力矩阵。
...
首批 Runtime 任务已经完成。当前按用户要求暂停，恢复后从 T05 开始，不提前开发 Scene Router：
...
T00（DONE）
  → T05 outcome/result 契约（READY，暂停前未领取）
```
